...
vector2_t vector2_mult(vector2_t a,double b)
{
return vector2(a.x*b,a.y*b);
}
double vector2_norm(vector2_t a)
{
...
double vector3_magnitude(vector3_t a)
{
...
{
double angle=vector3_magnitude(axis);
...
quaternion_t quaternion_scale(quaternion_t q,double s)
{
...
{
double magnitude=quaternion_magnitude(q);
...
/*
double matrix_determinant(matrix_t mat)
{
...
{
double determinant=matrix_determinant(mat);
return matrix(
